  ...
  return (
    <div className="section">
      ...
      <div style={{display:'flex', gap:12}}>
        ...
        <Link href={`/questionnaires/vsme?project=${encodeURIComponent(project)}`} className="btn btn-ghost">Open VSME</Link>
        <Link href={`/questionnaires/esglite?project=${encodeURIComponent(project)}`} className="btn btn-ghost">Open ESGLite</Link>
      </div>
    </div>
  );
}
